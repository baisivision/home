(function(a) {
    ...
    a(function() {
            ...
            a(b).outerFind("[data-bg-video]").each(function() {
                ...
                if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                    if (c && /youtu\.?be/g.test(c[3]))
                        ...
                        !a.fn.YTPlayer || f || a.isMobile() || a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer({
                            videoURL: c[6],
                            containment: "self",
                            showControls: !1,
                            mute: !0
        ...
        a(window).scroll(function() {
            ...
            if (g) {
                ...
                c ? d != g.fixed && (l ? (g.fixed = d,
                a(g.elm).toggleClass("is-fixed")) : h = setTimeout(function() {
                    g.fixed = d;
    ...
    ;
    f || ("undefined" === typeof window.initClientPlugin && 0 != a(document.body).find(".clients").length && (window.initClientPlugin = !0,
    a(document.body).find(".clients").each(function(b, c) {
        a(this).attr("data-isinit") || (p(a(this)),
        q(a(this)))
    })),
    ...
    "undefined" === typeof window.initTabsPlugin && (window.initTabsPlugin = !0,
    r(document.body)),
