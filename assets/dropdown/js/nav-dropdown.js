(function(c) {
    var l = c.fn.navDropdown
      ...
      , h = function() {
        ...
        a.prototype.prop = function(a, d) {
            return arguments.length ? 1 < arguments.length ? (this.props[a] = d,
            this) : "object" == typeof arguments[0] ? (c.extend(this.props, arguments[0]),
            this) : a in this.props ? this.props[a] : null : c.extend({}, this.props)
        }
        ;
        ...
        a.prototype.is = function(a) {
            for (var d = c(this), e = (a || "").split(/(?=[*#.\[:\s])/); a = e.pop(); )
                switch (a) {
                case ":root":
    ...
    f._clearMenus = function(a) {
        ...
        if (3 !== a.which) {
            ...
            if (a.target) {
                ...
                else if (c(a.target).hasClass("dropdown-backdrop") && (e = c(a.target).next(),
            ...
            for (e = 0; e < d.length; e++) {
                ...
                if (c(g).hasClass("open") && ("click" !== a.type || !/input|textarea/i.test(a.target.tagName) || !c.contains(g, a.target))) {
                    ...
                    c(g).trigger(k);
                    k.isDefaultPrevented() || (d[e].setAttribute("aria-expanded", "false"),
                    c(g).removeClass("open").trigger(c.Event("hidden.bs.nav-dropdown", h)))
                }
            }
    ...
    f._dataApiKeydownHandler = function(a) {
        if (!/input|textarea/i.test(a.target.tagName)) {
            ...
            b && (a.preventDefault(),
            a.stopPropagation(),
            a.which == g.ESC ? f._isCollapsed(this) || (a = c(a.target).parents(".dropdown.open").last().find('>[data-toggle="dropdown-submenu"]'),
            f._clearMenus(),
            a.trigger("focus")) : "A" == a.target.tagName && (b = h(a.target),
            b.prop(":flat", f._isCollapsed(b.root())),
            b.is(":flat") ? a.which === g.DOWN || a.which === g.UP ? b[a.which === g.UP ? "prev" : "next"]().focus() : a.which === g.LEFT ? b.is(":opened") ? b.close() : b.parent().close().focus() : a.which === g.RIGHT && b.is(":toggle") && b.open() : b.is(":upper") ? a.which === g.LEFT || a.which === g.RIGHT ? (b[a.which === g.LEFT ? "prev" : "next"]().focus().open(),
            b.is(":toggle") && b.close()) : a.which !== g.DOWN && a.which !== g.UP || !b.is(":toggle") || b.children()[a.which === g.DOWN ? "first" : "last"]().focus() : a.which === g.LEFT ? (a = b.parent(),
            a.is(":upper") ? a.close().prev().focus().open() : a.focus().close()) : a.which === g.RIGHT ? (a = b.children(),
            a.length ? (b.open(),
            a.first().focus()) : b.parents(":upper").close().next().focus().open()) : a.which !== g.DOWN && a.which !== g.UP || b[a.which === g.UP ? "prev" : "next"]().focus()))
        }
    }
    ;
