    ...
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            return this.each(function() {
                ...
                jQuery.mbCookie.get("YTPlayer_" + YTPlayer.videoID) && (start_from_last = parseFloat(jQuery.mbCookie.get("YTPlayer_" + YTPlayer.videoID))),
                ...
                !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    ...
                    jQuery.mbBrowser.mobile || (playerBox.after(overlay),
        ...
        getDataFromAPI: function(a) {
            ...
            !a.isPlayer || a.opt.autoPlay || jQuery.mbBrowser.mobile || (a.loading = jQuery("<div/>").addClass("loading").html("Loading").hide(),
