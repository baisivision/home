    ...
    jQuery.vimeo_player = {
        ...
        buildPlayer: function(b) {
            ...
            return this.each(function() {
                ...
                var e = f.data("property") && "string" == typeof f.data("property") ? eval("(" + f.data("property") + ")") : f.data("property");
                ...
                a.isAlone = !1;
                a.hasFocus = !0;
                a.videoID = this.opt.videoURL ? get_vimeo_videoID(this.opt.videoURL) : f.attr("href") ? get_vimeo_videoID(f.attr("href")) : !1;
                ...
                if (!a.isBackground || !a.backgroundIsInited) {
                    ...
                    var e = jQuery("<div/>").css({
                      ...
                      , g = jQuery("<div/>").addClass("vimeo_player_wrapper").attr("id", "vimeo_player_wrapper_" + d);
                    g.css({
                        position: "absolute",
                        zIndex: 0,
                        minWidth: "100%",
                    ...
                    if (!jQuery.browser.mobile || a.canPlayOnMobile) {
                        ...
                        jQuery.browser.mobile || (a.playerBox.after(e),
                        a.overlay = e);
                        if (!a.isBackground)
                        ...
                        jQuery(document).on("vimeo_api_loaded", function() {
                            ...
                            a.player.ready().then(function() {
                                ...
                                a.player.on("play", function(b) {
                                    ...
                                    a.controlBar && a.controlBar.length && a.controlBar.find(".vimeo_player_pause").html(jQuery.vimeo_player.controls.pause);
                                ...
                                a.player.on("timeupdate", function(b) {
                                    ...
                                    a.opt.stopMovieOnBlur && !document.hasFocus() && 1 == a.state && (a.hasFocus = !1,
                                    f.v_pause(),
                                    a.document_focus = setInterval(function() {
                                        document.hasFocus() && !a.hasFocus && (a.hasFocus = !0,
                                        f.v_play(),
                                    ...
                                    if (a.opt.showControls) {
                                        ...
                                        b.duration ? a.controlBar.find(".vimeo_player_time").html(jQuery.vimeo_player.formatTime(b.seconds) + " / " + jQuery.vimeo_player.formatTime(b.duration)) : a.controlBar.find(".vimeo_player_time").html("-- : -- / -- : --")
                                    }
                                    a.opt.addRaster ? (g = "dot" == a.opt.addRaster ? "raster-dot" : "raster",
                                    a.overlay.addClass(a.isRetina ? g + " retina" : g)) : a.overlay.removeClass(function(a, b) {
                                        var c = b.split(" ")
                                          , e = [];
                                    ...
                                    b.seconds >= (a.opt.stopAt || b.duration - .6) && (a.loop = a.loop || 0,
                                    a.opt.loop && a.loop < a.opt.loop ? (f.v_seekTo(a.opt.startAt),
                                    a.loop++) : (f.v_pause(),
                                    a.state = 0,
                                    f.trigger("change_state")));
                        ...
                        a.opt.mobileFallbackImage && g.css({
        ...
        setVolume: function(b) {
            ...
            b || c.opt.vol || !c.isMute ? !b && !c.isMute || b && c.opt.vol == b ? c.isMute ? jQuery(c).v_mute() : jQuery(c).v_unmute() : (c.opt.vol = b,
            c.player.setVolume(c.opt.vol),
            c.volumeBar && c.volumeBar.length && c.volumeBar.updateSliderVal(100 * b)) : jQuery(c).v_unmute();
            return this
        },
        ...
        mute: function() {
            ...
            if (!b.isMute)
                ...
                b.volumeBar && b.volumeBar.length && 10 < b.volumeBar.width() && b.volumeBar.updateSliderVal(0),
                jQuery("#controlBar_" + b.id).find(".vimeo_player_muteUnmute").html(jQuery.vimeo_player.controls.unmute),
        ...
        unmute: function() {
            ...
            if (b.isMute)
                ...
                b.volumeBar && b.volumeBar.length && b.volumeBar.updateSliderVal(.1 < b.opt.vol ? b.opt.vol : .1),
                jQuery("#controlBar_" + b.id).find(".vimeo_player_muteUnmute").html(jQuery.vimeo_player.controls.mute),
        ...
        buildControls: function(b) {
            ...
            if (!jQuery("#controlBar_" + b.id).length) {
                ...
                var k = jQuery("<span/>").addClass("vimeo_player_time")
                  ...
                  , h = jQuery("<span/>").html(jQuery.vimeo_player.controls.logo).addClass("vimeo_url vimeo_icon").attr("title", "view on Vimeo").on("click", function() {
                    console.debug(g);
        ...
        optimizeVimeoDisplay: function(b) {
            ...
            if (c.opt.optimizeDisplay) {
                ...
                var l = a < h;
                l && (a = h + k,
                e = "16/9" == c.opt.ratio ? Math.floor(16 / 9 * a) : Math.floor(4 / 3 * a),
                f = 0,
                d = -((e - g) / 2));
                for (var m in b)
        ...
        fullscreen: function(b) {
            ...
            if (b) {
                ...
                jQuery(document).off(l).on(l, function() {
                    c(document, "IsFullScreen") || c(document, "FullScreen") ? p = jQuery.Event("VPFullScreenStart") : (a.isAlone = !1,
...
jQuery.browser.fullVersion = "" + parseFloat(navigator.appVersion),
jQuery.browser.majorVersion = parseInt(navigator.appVersion, 10),
-1 != (verOffset = nAgt.indexOf("Opera")) ? (jQuery.browser.opera = !0,
jQuery.browser.name = "Opera",
jQuery.browser.fullVersion = nAgt.substring(verOffset + 6),
-1 != (verOffset = nAgt.indexOf("Version")) && (jQuery.browser.fullVersion = nAgt.substring(verOffset + 8))) : -1 != (verOffset = nAgt.indexOf("OPR")) ? (jQuery.browser.opera = !0,
jQuery.browser.name = "Opera",
jQuery.browser.fullVersion = nAgt.substring(verOffset + 4)) : -1 != (verOffset = nAgt.indexOf("MSIE")) ? (jQuery.browser.msie = !0,
jQuery.browser.name = "Microsoft Internet Explorer",
jQuery.browser.fullVersion = nAgt.substring(verOffset + 5)) : -1 != nAgt.indexOf("Trident") || -1 != nAgt.indexOf("Edge") ? (jQuery.browser.msie = !0,
jQuery.browser.name = "Microsoft Internet Explorer",
start = nAgt.indexOf("rv:") + 3,
end = start + 4,
jQuery.browser.fullVersion = nAgt.substring(start, end)) : -1 != (verOffset = nAgt.indexOf("Chrome")) ? (jQuery.browser.webkit = !0,
jQuery.browser.chrome = !0,
jQuery.browser.name = "Chrome",
jQuery.browser.fullVersion = nAgt.substring(verOffset + 7)) : -1 < nAgt.indexOf("mozilla/5.0") && -1 < nAgt.indexOf("android ") && -1 < nAgt.indexOf("applewebkit") && !(-1 < nAgt.indexOf("chrome")) ? (verOffset = nAgt.indexOf("Chrome"),
jQuery.browser.webkit = !0,
